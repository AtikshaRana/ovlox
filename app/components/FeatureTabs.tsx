...
export default function FeatureTabs() {
  ...
  return (
  <section className="py-16 bg-[#8cdff4] relative ">
  ...
  <div className="container mx-auto px-4 relative z-10">
    <div className="flex flex-col md:flex-row gap-10 p-8 md:p-10">
        ...
        {data.map((item, index) => (
          <div
            ...
            className={`p-5 rounded-2xl cursor-pointer border transition-all 
              ...
              ${
                active === index
                  ? "bg-gradient-to-r from-[#22598e]  text-white shadow-xl scale-105 transform"
      ...
      <div className="flex-1 flex flex-col gap-6">
        ...
        <div className="rounded-3xl w-full md:w-[70%] h-[550px] overflow-hidden shadow-lg transition-transform duration-500 hover:scale-[1.02]">
          <img
            src={data[active].image}
            alt={data[active].title}
            className="w-full h-full md:h-full object-cover transition-all duration-500"
          />
        </div>
