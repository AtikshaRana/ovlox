...
export async function POST(req: Request) {
    // Initialize Resend with API Key from environment variables inside the handler
    // to prevent build-time errors if the variable is missing during static generation.
